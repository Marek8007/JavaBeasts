...
public class Testing implements CommandLineRunner {
    ...
    public Testing(MoveRepository moveRepo, TypeRepository typeRepo, JaBeaRepository jaBeaRepo, JaBeasTeamedRepository jaBeaTeamedRepo) {
    ...
    public void run(String... args) {
        ...
        Combat combat = new Combat(jbt1, jbt2);
